...
function CustomDrawerContent({ navigation }) {
  ...
  const menuItems = [
    ...
    { label: "All Experts", icon: require('../assets/icons8-user-folder-48.png') },
    { label: "Growth Plan", icon: require('../assets/icons8-growth-50.png') },
    ...
    { label: "Sessions", icon: require('../assets/icons8-people-48.png') },
        ...
        <TouchableOpacity onPress={handleProfileClick}>
          ...
          <View style={styles.profileInfo}>
            ...
            <View style={{ marginLeft: 5 }}>
              <Text style={{ fontSize: 17, color: 'black' }}>John Smith</Text>
            </View>
          </View>
        </TouchableOpacity>
        <View style={styles.divider} />
