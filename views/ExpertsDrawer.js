...
function ExpertsDrawerContent({ navigation }) {
  const [expandedItem, setExpandedItem] = useState(null);

  const menuItems = [
    { label: "Home", icon: require('../assets/icons8-home-50.png') },
    { label: "Offers", icon: require('../assets/expertsbids.png') },
    { label: "Growth Plans", icon: require('../assets/icons8-growth-50.png') },
    { label: "Interview", icon: require('../assets/icons8-discussion-48.png') },
    { label: "Advice", icon: require('../assets/icons8-messages-50.png') },
    { label: "Hubs", icon: require('../assets/icons8-expert-50.png') },
    { label: "Messages", icon: require('../assets/icons8-email-64.png') },
        ...
        <TouchableOpacity onPress={handleProfileClick}>
          ...
          <View style={styles.profileInfo}>
            ...
            <View style={{ marginLeft: 5 }}>
              <Text style={{ fontSize: 17, color: 'black' }}>Joop Melcher</Text>
            </View>
          </View>
        </TouchableOpacity>
        <View style={styles.divider} />
...
export default ExpertsDrawerContent;
