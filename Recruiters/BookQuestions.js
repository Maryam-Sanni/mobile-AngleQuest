...
<View style={styles.header}>
        ...
        <Text style={{ fontSize: 16, color: 'black', fontWeight: 'bold', marginTop: 20, marginLeft: 20 }}>Interview Questions</Text>
        <Text style={{  color: 'black', marginTop: 10, marginLeft: 20, marginBottom: 20}}>Do you have question(s) you will like the expert to ask the candidate for you?</Text>
