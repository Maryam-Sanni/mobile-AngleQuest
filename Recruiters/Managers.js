...
/>
    ...
    <View style={{ position: 'absolute', right: 30, paddingHorizontal: 8, paddingVertical: 8, borderRadius: 5, backgroundColor: 'coral', width: 100, alignItems: 'center',}}>
     ...
     <Text style={{ fontSize: 15, color: "black", marginTop: 10, marginLeft: 10, marginRight: 150, color: 'white',fontFamily:"Varta-Light" }}>Assign managers to oversee the daily tasks and career development of their team members, while Recruitangle will assign subject matter experts to tutor and guide the growth of employees.</Text>
