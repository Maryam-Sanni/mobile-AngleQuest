...
/>
    ...
    <View style={{ position: 'absolute', right: 30, paddingHorizontal: 8, paddingVertical: 8, borderRadius: 5, backgroundColor: 'coral', width: 100, alignItems: 'center',}}>
     ...
     <View style={styles.blurBox}>
      ...
      <Text style={{ fontSize: 19, fontWeight: 'bold', marginTop: 10, marginLeft: 10, color: '#63EC55',fontFamily:"Varta-Light"}}>Engage your coaches to support and guide employees</Text>
     <Text style={{ fontSize: 15, color: "black", marginTop: 10, marginLeft: 10, marginRight: 150, color: 'white',fontFamily:"Varta-Light" }}>Assign coaches to mentor and support team members in their daily tasks and career development, while Recruitangle will assign subject matter experts to tutor and guide the growth of employees.</Text>
