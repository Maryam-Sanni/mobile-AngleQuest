...
import { useBusinessDrawerContext } from '../views/RecruitersDrawerContext';

const HomePage = () => {
  const navigation = useNavigation();
  const [modalVisible, setModalVisible] = useState(false);
  const [modalVisible2, setModalVisible2] = useState(false);
  const { setIsBusinessDrawer } = useBusinessDrawerContext();

  useEffect(() => {
    setIsBusinessDrawer(true);
    return () => setIsBusinessDrawer(false);
  }, [setIsBusinessDrawer]);
  ...
  return (
     <View style={{backgroundColor: '#3F5B39', flex: 1}}>
      ...
      <Text style={styles.greeting}>Good Day, Pretzel Ent.</Text>
          ...
          <Text style={{fontSize: 22, color: '#63EC55', fontWeight: 'bold', marginTop: 5, }}>Orchestrate the growth of everyone in your team</Text>
...
<Text style={{fontSize: 20, color: '#63EC55', marginTop: 15, marginLeft: 30, fontWeight: 'bold' }}>Upcoming Growth Plan Session</Text>
...
<Image
            ...
            />
              <Text style={{fontSize: 14, color: 'white', marginTop: 20, marginLeft: 10, fontWeight: '600', width: 190 }}>Maryam Bakahali with expert Joop Melcher</Text>
...
<Image
              ...
              style={{ width: 30, height: 30,  marginLeft: 30, marginTop: 15,}}
            />
              <Text style={{fontSize: 14, color: 'white', marginTop: 20, marginLeft: 10, fontWeight: '600', width: 190 }}>Eniobanke Ademide with expert Emily Ray</Text>
<TouchableOpacity style={styles.touchablestart}>
          <Text style={styles.touchableTextjoinreview}>Join</Text>
          </TouchableOpacity>
          </View>
...
<Image
              ...
              style={{ width: 30, height: 30,  marginLeft: 30, marginTop: 15,}}
            />
              <Text style={{fontSize: 14, color: 'white', marginTop: 20, marginLeft: 10, fontWeight: '600', width: 190 }}>Patrick King with expert Wicher Jeroen</Text>
<TouchableOpacity style={styles.touchablestart}>
          <Text style={styles.touchableTextjoinreview}>Join</Text>
          </TouchableOpacity>
          </View>
      ...
      />
          ...
          <Text style={{fontSize: 14, color: 'white', marginTop: 10, marginLeft: 35,marginRight: 20  }}>Wicher Jeroen payment is due 12th of June 2024</Text>
          <TouchableOpacity style={styles.touchablecoach}>
          <Text style={styles.touchableTextjoinreview}>Renew Now</Text>
          </TouchableOpacity>
          </BlurView>
          </View>
