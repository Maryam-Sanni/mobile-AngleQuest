...
import OpenModal from './Paymentdetailsgrowth';
  ...
  return (
    <View style={{  flex: 1, backgroundColor: "#F8F8F8", marginTop: 40, alignItems: 'center' }}>
      ...
      <Text style={{color: 'black', fontSize: 18, fontWeight: 'bold', marginBottom: 40, marginLeft: 30 }}>Hello Patrick, Review your cart </Text>
       <Text style={{fontSize: 14, color: '#206C00', marginLeft: 30 }}>$50 for Growth Plan  </Text>
    <View style={styles.box}>
 <Text style={{fontSize: 14, color: '#206C00', marginLeft: 10, marginTop: 15  }}>• Joop Melcher will review your plan </Text>
 <Text style={{fontSize: 14, color: '#206C00', marginLeft: 10, marginTop: 5  }}>• You will have a One-on-One meeting with him to discuss the strategy on how to achieve this growth plan </Text>
 <Text style={{fontSize: 14, color: '#206C00', marginLeft: 10, marginBottom: 15, marginTop: 5  }}>• Then every Quarter you will have a review session with Joop Melcher </Text>
 </View>
 <Text style={{fontSize: 14, color: '#206C00', marginLeft: 30, marginTop: 50 }}>Total: $50</Text>
