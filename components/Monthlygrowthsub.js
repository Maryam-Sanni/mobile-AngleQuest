    ...
    return (
                <View style={{ flex: 1, backgroundColor: "#F8F8F8", marginTop: 40, alignItems: 'center' }}>
                    <View style={styles.greenBox}>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 30 }}>$80 for Monthly Subscription</Text>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 30, marginTop: 30 }}>Total: $80</Text>
