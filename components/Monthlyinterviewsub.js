    ...
    return (
                <View style={{ flex: 1, backgroundColor: "#F8F8F8", marginTop: 40, alignItems: 'center' }}>
                    ...
                    <View style={styles.greenBox}>
                        ...
                        <Text style={{ color: 'black', fontSize: 18, fontWeight: 'bold', marginBottom: 40, marginLeft: 30 }}>Hi Patrick, Congratulations for taking the plunge </Text>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 30, marginTop: 35 }}>$80 for Monthly Subscription</Text>
                        <View style={styles.box}>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 30, marginTop: 50 }}>Total: $95</Text>
