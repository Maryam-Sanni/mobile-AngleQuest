    ...
    return (
                <View style={{ flex: 1, backgroundColor: "#F8F8F8", marginTop: 40, alignItems: 'center' }}>
                    <View style={styles.greenBox}>
                        ...
                        <Text style={{ color: 'black', fontSize: 18, fontWeight: 'bold', marginBottom: 40, marginLeft: 30, marginTop: 20 }}>Hi Patrick, Congratulations for taking the plunge </Text>
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 30, }}>$840 for Annual Subscription</Text>
                        ...
                        <Text style={{ fontSize: 14, color: '#206C00', marginLeft: 30, marginTop: 30 }}>Total: $840</Text>
