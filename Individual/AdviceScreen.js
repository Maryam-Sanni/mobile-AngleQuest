...
import OpenModal from '../Individual/PickAdviceCoach';
import OpenModal2 from '../Individual/NewAdvice';
                    ...
                    <View style={styles.glassBox}>
                        <View style={styles.innerContainer}>
                            ...
                            <View style={styles.content}>
                                <Text style={styles.boxTitle}>About Advice</Text>
                                <Text style={styles.boxText}>Are you in a place where you need some straightening, fresh insights, leverage new perspective and some realignment?</Text>
                                <View style={styles.buttonContainer}>
                                    <TouchableOpacity onPress={handleOpenPress}>
                                        <View style={styles.button}>
                                            <Text style={styles.buttonText}>Meet an Expert</Text>
                                        </View>
                                    </TouchableOpacity>
