...
import OpenSchedule from '../components/Skipgrowthsub';
import OpenSchedule2 from '../components/Monthlygrowthsub';
import OpenSchedule3 from '../components/AnnualgrowthSub';
...
const App = () => {
  ...
  const goToPlans = () => {
    ...
    navigation.navigate('Choose Growth Payment');
