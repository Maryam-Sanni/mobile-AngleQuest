...
import OpenSchedule from '../components/Skipinterviewsub';
import OpenSchedule2 from '../components/Monthlyinterviewsub';
import OpenSchedule3 from '../components/AnnualinterviewSub';
...
const App = () => {
  ...
  const goToPlans = () => {
    ...
    navigation.navigate('Choose Interview Payment');
