                    ...
                    <View style={styles.glassBox}>
                        <View style={styles.innerContainer}>
                            <View style={styles.header}>
                                <TouchableOpacity>
                                    <View style={styles.item}>
                                        ...
                                        <Text style={styles.headerText}>Coaching Hubs</Text>
                                    </View>
                                </TouchableOpacity>
                            ...
                            <View style={styles.content}>
                                <Text style={styles.boxTitle}>About Hubs</Text>
                                <Text style={styles.boxText}>The goal of a hub is to provide practical knowledge that will enable it's members to grow from one level to the next level in their career.</Text>
                                <View style={styles.buttonContainer}>
                                    <TouchableOpacity onPress={handleOpenPress}>
                                        <View style={styles.button}>
                                            <Text style={styles.buttonText}>Join a Hub</Text>
                                        </View>
                                    </TouchableOpacity>
